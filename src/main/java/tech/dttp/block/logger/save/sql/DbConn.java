...
public class DbConn {
    ...
    private final static DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss z")
    ...
    public static void writeBreak(int x, int y, int z, BlockState state, PlayerEntity player, World world) {
        if (con == null) {
